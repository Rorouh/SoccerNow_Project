...
class PlayerControllerTest {
  ...
  void testGetPlayerById_found() {
    ...
    assertEquals(Player.PreferredPosition.DEFENSA, response.getBody().getPreferredPosition());
  }
  ...
  void testUpdatePlayer_success() {
    ...
    assertEquals(Player.PreferredPosition.DELANTERO, response.getBody().getPreferredPosition());
  }
  ...
  void testListPlayers_byPosition() {
    ...
    assertEquals(
        Player.PreferredPosition.DEFENSA, response.getBody().get(0).getPreferredPosition());
  }
