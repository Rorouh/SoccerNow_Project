...
public class JogoDTO {
  ...
  // Human readable team names for displaying in views
  ...
  public static JogoDTO fromEntity(Jogo j) {
    ...
    d.setHomeTeamName(j.getHomeTeam().getName());
    d.setAwayTeamId(j.getAwayTeam().getId());
    d.setAwayTeamName(j.getAwayTeam().getName());
    d.setCampeonatoId(j.getCampeonato() != null ? j.getCampeonato().getId() : null);
    d.setRefereeIds(j.getReferees().stream().map(r -> r.getId()).collect(Collectors.toSet()));
  ...
  public boolean isAmigavel() {
    return amigavel;
  }

  public void setAmigavel(boolean amigavel) {
  ...
  public Set<Long> getArbitroIds() {
    return arbitroIds;
  }

  public void setArbitroIds(Set<Long> arbitroIds) {
    this.arbitroIds = arbitroIds;
  }

  public Long getPrimaryRefereeId() {
    return primaryRefereeId;
  }

  public void setPrimaryRefereeId(Long primaryRefereeId) {
